...
data PlatformConstants = PlatformConstants {
      ...
      pc_SIZEOF_StgAnnFrame_NoHdr :: {-# UNPACK #-} !Int,
  ...
  return $! case readVal (find def s) of
    [v0,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15
     ...
     ,v128,v129,v130,v131
            ...
            , pc_SIZEOF_StgAnnFrame_NoHdr = fromIntegral v80
            , pc_SIZEOF_StgMutArrPtrs_NoHdr = fromIntegral v81
            , pc_OFFSET_StgMutArrPtrs_ptrs = fromIntegral v82
            , pc_OFFSET_StgMutArrPtrs_size = fromIntegral v83
            , pc_SIZEOF_StgSmallMutArrPtrs_NoHdr = fromIntegral v84
            , pc_OFFSET_StgSmallMutArrPtrs_ptrs = fromIntegral v85
            , pc_SIZEOF_StgArrBytes_NoHdr = fromIntegral v86
            , pc_OFFSET_StgArrBytes_bytes = fromIntegral v87
            , pc_OFFSET_StgTSO_alloc_limit = fromIntegral v88
            , pc_OFFSET_StgTSO_cccs = fromIntegral v89
            , pc_OFFSET_StgTSO_stackobj = fromIntegral v90
            , pc_OFFSET_StgStack_sp = fromIntegral v91
            , pc_OFFSET_StgStack_stack = fromIntegral v92
            , pc_OFFSET_StgUpdateFrame_updatee = fromIntegral v93
            , pc_OFFSET_StgOrigThunkInfoFrame_info_ptr = fromIntegral v94
            , pc_OFFSET_StgFunInfoExtraFwd_arity = fromIntegral v95
            , pc_REP_StgFunInfoExtraFwd_arity = fromIntegral v96
            , pc_SIZEOF_StgFunInfoExtraRev = fromIntegral v97
            , pc_OFFSET_StgFunInfoExtraRev_arity = fromIntegral v98
            , pc_REP_StgFunInfoExtraRev_arity = fromIntegral v99
            , pc_MAX_SPEC_SELECTEE_SIZE = fromIntegral v100
            , pc_MAX_SPEC_AP_SIZE = fromIntegral v101
            , pc_MIN_PAYLOAD_SIZE = fromIntegral v102
            , pc_MIN_INTLIKE = fromIntegral v103
            , pc_MAX_INTLIKE = fromIntegral v104
            , pc_MIN_CHARLIKE = fromIntegral v105
            , pc_MAX_CHARLIKE = fromIntegral v106
            , pc_MUT_ARR_PTRS_CARD_BITS = fromIntegral v107
            , pc_MAX_Vanilla_REG = fromIntegral v108
            , pc_MAX_Float_REG = fromIntegral v109
            , pc_MAX_Double_REG = fromIntegral v110
            , pc_MAX_Long_REG = fromIntegral v111
            , pc_MAX_XMM_REG = fromIntegral v112
            , pc_MAX_Real_Vanilla_REG = fromIntegral v113
            , pc_MAX_Real_Float_REG = fromIntegral v114
            , pc_MAX_Real_Double_REG = fromIntegral v115
            , pc_MAX_Real_XMM_REG = fromIntegral v116
            , pc_MAX_Real_Long_REG = fromIntegral v117
            , pc_RESERVED_C_STACK_BYTES = fromIntegral v118
            , pc_RESERVED_STACK_WORDS = fromIntegral v119
            , pc_AP_STACK_SPLIM = fromIntegral v120
            , pc_WORD_SIZE = fromIntegral v121
            , pc_CINT_SIZE = fromIntegral v122
            , pc_CLONG_SIZE = fromIntegral v123
            , pc_CLONG_LONG_SIZE = fromIntegral v124
            , pc_BITMAP_BITS_SHIFT = fromIntegral v125
            , pc_TAG_BITS = fromIntegral v126
            , pc_LDV_SHIFT = fromIntegral v127
            , pc_ILDV_CREATE_MASK = v128
            , pc_ILDV_STATE_CREATE = v129
            , pc_ILDV_STATE_USE = v130
            , pc_USE_INLINE_SRT_FIELD = 0 < v131
            }
