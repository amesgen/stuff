...
alex_accept = listArray (0 :: Int, 248)
  ...
  , AlexAccPred 114 ( ifExtension UnboxedTuplesBit `alexOrPred`
           ifExtension UnboxedSumsBit )(AlexAccNone)
  , AlexAccPred 113 ( ifExtension UnboxedTuplesBit `alexOrPred`
           ifExtension UnboxedSumsBit )(AlexAccNone)
  , AlexAcc 112
  , AlexAcc 111
  , AlexAcc 110
